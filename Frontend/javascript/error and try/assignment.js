...
// console.log(convertToNumber("shreedhar"));
// console.log(convertToNumber("77hihgghgsd")); 
...
//       if(typeof (person)!="object" || !person.age || !person.name)
//       {
...
//     console.log(check({ name: "Mithun", age: 20 })); // Name: Mithun, Age: 20
// console.log(check({ name: "Mithun" })); // Invalid parameter type
// console.log(check(["name", "Mithun"])); // Invalid parameter type
...
//   // Expected output:
//   const user = new User("Shreedhar", "Password123");
//   console.log(user.getPassword()); // ***********
...
// const Student=new student ("shreedhar");
// Student.print();
